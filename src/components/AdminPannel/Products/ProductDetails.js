...
const ProductDetails = (props) => {
	...
	const handleDeleteProduct = () => {
		...
		fetch(`https://washyka-server.herokuapp.com/deleteProducts/${id}`, {
			method: 'DELETE'
		})
			.then((res) => res.json())
			.then((res) => {
	...
	const onProductSubmit = (data, e) => {
		...
		fetch('https://washyka-server.herokuapp.com/addProducts', {
			method: 'POST',
			headers: {
	...
	const onSubmit = (data) => {
		...
		fetch('https://washyka-server.herokuapp.com/updateProduct', {
			method: 'POST',
			headers: {
				'Content-type': 'application/json'
			},
